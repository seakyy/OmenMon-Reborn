    ...
    public class GuiOp {
        ...
        public void CheckThermalPanic(byte maxTemp) {
            ...
            if(!IsThermalPanic && maxTemp >= Config.ThermalPanicTemperature) {
                ...
                // Show temperature in the configured display unit (threshold is always °C internally)
                ...
                // Safe off-threshold: guard against hysteresis being misconfigured larger than threshold
